          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log(_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(query));

                _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(query).forEach(function (ele) {
                  console.log(query);
                });
